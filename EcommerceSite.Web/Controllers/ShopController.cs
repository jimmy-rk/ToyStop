...
namespace EcommerceSite.Web.Controllers
{
    ...
    public class ShopController : Controller
    {
        ...
        public ActionResult Index(string searchTerm,int? minimumPrice,int? maximumPrice,int? categoryID,int? sortBy,int? pageNo)
        {
            ...
            int totalProductsCount =  ProductsService.Instance.SearchProductsCount(searchTerm, minimumPrice, maximumPrice, categoryID, sortBy);
        ...
        public JsonResult PlaceOrder(string productIDs)
        {
            ...
            if (!string.IsNullOrEmpty(productIDs))
            {
                ...
                foreach(int pid in productQuantities)
                {
                    ProductsService.Instance.UpdateProductStock(pid);
                ...
                newOrder.OderedAt = DateTime.Now;
